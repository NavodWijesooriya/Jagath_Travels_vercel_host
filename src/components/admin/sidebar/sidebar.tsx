    ...
    <Box position="relative" display="flex">
      ...
      >
        ...
        <VStack spacing={0} align="stretch">
          ...
          <NavItem icon={FiMapPin} label="Gallery" onClick={() => router.push('/admin/addGallery')} isOpen={isOpen} />
          <NavItem icon={FiMapPin} label="Blog" onClick={() => router.push('/admin/addBlog')} isOpen={isOpen} />
          <NavItem icon={FiPackage} label="Review" onClick={() => router.push('/admin/viewReview')} isOpen={isOpen} />
