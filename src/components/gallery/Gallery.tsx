                ...
                <>
                    ...
                    {visibleCount < images.length && (
                        <div className="mt-6 sm:mt-10">
                            <button
                                onClick={() => setVisibleCount((prev) => prev + 8)} // Load 8 more images
                                className="px-6 py-2 bg-black text-white rounded-lg shadow-lg transition-transform transform hover:scale-105"
                            >
                                View More
                            </button>
                        </div>
