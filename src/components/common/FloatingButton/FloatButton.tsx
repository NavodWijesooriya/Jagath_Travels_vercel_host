  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={handleClick}
          className="fixed bottom-6 left-6 bg-gradient-to-r bg-slate-900 hover:from-emerald-700 hover:to-emerald-600 text-white font-bold py-4 px-6 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 group"
        >
